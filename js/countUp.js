...
function countUp(target, startVal, endVal, decimals, duration) {
    ...
    this.count = function(timestamp) {
        ...
        self.d.innerHTML = self.addCommas(self.frameVal.toFixed(decimals)) + ' ft.'; // customized for bridgestats
    ...
    self.d.innerHTML = self.addCommas(startVal.toFixed(decimals)) + ' ft.';
}
